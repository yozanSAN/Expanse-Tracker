                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <nav className="lg:col-span-3 space-y-2">
                        {['account', 'security', 'billing'].map((tab) => (
                            <button
                                ...
                                className={`w-full flex items-center justify-between p-4 rounded-xl transition-all capitalize ${activeTab === tab
                    ...
                    <main className="lg:col-span-9">
                        {activeTab === 'account' ? (
                            ...
                            <div className="bg-secondary rounded-3xl p-8 border border-tertiary/50 flex items-center justify-center h-48">
                                <p className="text-textMuted text-lg">Coming soon</p>
                            </div>
                        )}
                    </main>
                </div>
